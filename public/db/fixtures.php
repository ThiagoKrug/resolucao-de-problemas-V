...
choques. Rotação de corpos rígidos. Gravitação.', 'carga_horaria' => '75h', 'info_adicionais' => ''));
    ...
    $db->insert('usuario', array('nome' => 'Rudi Porto', 'matricula' => '3978452', 'email' => 'sec@sec.com', 'senha' => '1234567', 'tipo_usuario' => 'secretario'));
    $db->insert('usuario', array('nome' => 'Administrador', 'matricula' => '', 'email' => 'admin@admin.com', 'senha' => '1234567', 'tipo_usuario' => 'admin'));
